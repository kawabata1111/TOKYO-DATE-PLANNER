      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12">
        <div className="max-w-3xl">
          ...
          <motion.h1
            ...
            className="text-5xl md:text-7xl lg:text-8xl font-serif text-white leading-[1.1] mb-10 tracking-wide flex flex-col items-end md:items-start"
          >
          ...
          <motion.p
            ...
            className="text-white text-sm md:text-base leading-relaxed md:leading-loose font-light max-w-md border-l border-white/10 pl-4 md:pl-8 mb-16 whitespace-nowrap md:whitespace-normal mt-72 md:mt-0"
          >
